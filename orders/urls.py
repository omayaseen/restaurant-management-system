...
from .views import add_to_cart, view_cart, checkout,my_orders, order_details, cancel_order, manage_orders, update_order_status,increase_quantity, decrease_quantity, remove_from_cart
